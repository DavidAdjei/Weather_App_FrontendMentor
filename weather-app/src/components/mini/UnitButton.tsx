...
export default function UnitButton ({
  ...
  return (
    <button
      ...
      className={`w-full text-left px-3 py-2 rounded-md text-neutral-200 hover:bg-neutral-700 focus:outline-none focus:ring-2 focus:ring-neutral-500 flex justify-between md ${
